...
export type PatientAuditEventType =
  ...
  | "patient.localJsonExport"
  | "patient.localJsonBackupExport"
  | "patient.localJsonRestore"
  | "patient.localJsonRestoreFailed"
  | "patient.backupExport"
  | "patient.backupRestore"
  | "patient.backupRestoreFailed"
  | "patient.saveFailed"
